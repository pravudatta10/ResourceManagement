...
public class JobCardManagementController {
	...
	@PostMapping("/add")
	public String addjobCardManagement(@RequestBody JobCardManagementRequest jobCardManagementRequest)
	{
	...
	@PutMapping("/update")
	public String updatejobCardManagement(@RequestBody JobCardManagementRequest jobCardManagementRequest)
	{
