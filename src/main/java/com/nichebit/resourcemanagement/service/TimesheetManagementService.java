...
public class TimesheetManagementService {
	...
	public void mailScheduler(Employee employee) throws Exception {
		try {
			LocalDate currentDate = LocalDate.now();
			...
			System.out.println("Timesheet Mail Send Failed" + employee.getEmpname());
		}
	}
					...
					if (ts != null) {
						for (int day = 1; day <= 31; day++) {
							if (day == 1 && day == previousdays && ts.getDay01() == 0.0) {
								timesheetManagementServiceobj.mailScheduler(employee);
							}
