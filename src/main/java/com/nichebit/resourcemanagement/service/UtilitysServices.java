...
public  String excelForTimeSheet(String name,int financialyear,String month) throws FileNotFoundException
{
	...
	String filePath= "C:\\Users\\kpds0\\Desktop\\ServerPath"+"ResourceManager.xlsx" ;
...
//StyleForHeader.setFillPattern(FillPatternType.FINE_DOTS);
...
tscell.setCellStyle(StyleForHeader);
...
for(int i=0;i<days;i++)
{
	...
	{
		row.createCell((short) cell).setCellValue(Day[i]);row.getCell(cell).setCellStyle(StyleNormalcoloumsforweakoff);
		row.createCell((short) ++cell).setCellValue(Date[i]);row.getCell(cell).setCellStyle(StyleNormalcoloumsforweakoff);
		row.createCell((short) ++cell).setCellValue(DayPro[i].substring(0,DayPro[i].length()-1));row.getCell(cell).setCellStyle(StyleNormalcoloumsforweakoff);
		row.createCell((short) ++cell).setCellValue(DayHrs[i]);row.getCell(cell).setCellStyle(StyleNormalcoloumsforweakoff);
	}
	else
	{
	row.createCell((short) cell).setCellValue(Day[i]);row.getCell(cell).setCellStyle(StyleNormalcoloums);
	row.createCell((short) ++cell).setCellValue(Date[i]);row.getCell(cell).setCellStyle(StyleNormalcoloums);
	row.createCell((short) ++cell).setCellValue(DayPro[i].substring(0,DayPro[i].length()-1));row.getCell(cell).setCellStyle(StyleNormalcoloums);
	row.createCell((short) ++cell).setCellValue(DayHrs[i]);row.getCell(cell).setCellStyle(StyleNormalcoloums);
	}
}

int cellforwidth=0;

sheet.setColumnWidth((short) cellforwidth, 8000);
sheet.setColumnWidth((short) ++cellforwidth, 8000);
sheet.setColumnWidth((short) ++cellforwidth, 8000);
sheet.setColumnWidth((short) ++cellforwidth, 8000);
