package com.nichebit.resourcemanagement.filter;
...
public class AuthenticationTokenFilter extends OncePerRequestFilter{
	...
	@Autowired
	private AuthenticateTokenService authService;
	@Autowired
	private EmployeeUserDetailsService empUserDetailsService;
	@Override
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		{
			UserDetails userDetails = empUserDetailsService.loadUserByUsername(username);
